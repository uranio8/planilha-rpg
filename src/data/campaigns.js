// src/data/campaigns.js - Dados iniciais e estrutura de Campanhas, Diários e Inventário Compartilhado
...
const INITIAL_CAMPAIGNS = [
  {
    ...
    partyStash: {
      ...
      items: [
        ...
        { id: "it_3", name: "Tochas", qty: 8, category: "Equipamento de Aventura", carrier: "Valerius", desc: "Ilumina raio de 6m por 1 hora." },
        { id: "it_4", name: "Varinha de Mísseis Mágicos", qty: 1, category: "Itens Mágicos", carrier: "Lyra", desc: "Possui 7 cargas. Permite lançar Mísseis Mágicos sem gastar espaço." },
        { id: "it_5", name: "Mapa Antigo de Wave Echo Cave", qty: 1, category: "Documentos & Pistas", carrier: "Irmão Theron", desc: "Pergaminho em élfico arcaico mostrando as passagens subterrâneas." }
      ],
      history: [
