// src/data/classes.js - D&D 5E (Edição 2024 / Segredos de Alancia)
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Fúria, Defesa sem Armadura, Maestria em Armas",
        "rages": "2",
        "rageDmg": "+2",
        "mastery": "2"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Ataque Descuidado, Sentido de Perigo",
        "rages": "2",
        "rageDmg": "+2",
        "mastery": "2"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Bárbaro, Conhecimento Primevo",
        "rages": "3",
        "rageDmg": "+2",
        "mastery": "2"
      },
      {
        "level": 4,
        "prof": "+2",
        "features": "Aumento no Valor de Atributo / Talento",
        "rages": "3",
        "rageDmg": "+2",
        "mastery": "3"
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Ataque Extra, Movimento Rápido (+3m)",
        "rages": "3",
        "rageDmg": "+2",
        "mastery": "3"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Habilidade de Subclasse",
        "rages": "4",
        "rageDmg": "+2",
        "mastery": "3"
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Instinto Feral, Bote Instintivo",
        "rages": "4",
        "rageDmg": "+2",
        "mastery": "3"
      },
      ...
      },
      {
        "level": 13,
        "prof": "+5",
        "features": "Crítico Melhorado / Golpe Brutal Aprimorado",
        "rages": "5",
        "rageDmg": "+3",
        "mastery": "4"
      },
      ...
      },
      {
        "level": 17,
        "prof": "+6",
        "features": "Golpe Brutal Adicional (2d10)",
        "rages": "6",
        "rageDmg": "+4",
        "mastery": "4"
      },
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Campeão Primevo (+4 Força e +4 Constituição, máx 25)",
        "rages": "Ilimitado",
        "rageDmg": "+4",
        "mastery": "4"
      }
        ...
        "features": [
          {
            "level": 3,
            "name": "Frenesi (Frenzy)",
            "desc": "Ao usar Ataque Descuidado durante a Fúria, você pode causar dano extra igual a 1d6 por nível de fúria no primeiro alvo acertado no turno."
          },
          {
            "level": 6,
            "name": "Fúria Insensível (Mindless Rage)",
            "desc": "Enquanto estiver em Fúria, você se torna imune às condições Enfeitiçado e Amedrontado. Se entrar em fúria enquanto estiver sob tais efeitos, eles são suspensos."
          },
          {
            "level": 10,
            "name": "Retaliação (Retaliation)",
            "desc": "Quando sofrer dano de uma criatura a até 1,5m de você, você pode usar sua Reação para desferir um ataque corpo a corpo com arma contra ela."
          },
          {
            "level": 14,
            "name": "Presença Intimidadora (Intimidating Presence)",
            "desc": "Como ação bônus, você ruge aterrorizando criaturas a até 9 metros. Alvos que falharem em salvaguarda de Sabedoria ficam Amedrontados por 1 minuto."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Fúria Animal (Rage of the Wilds)",
            "desc": "Escolha um aspecto animal ao entrar em fúria:\n• **Urso**: Resistência a todos os tipos de dano (exceto psíquico).\n• **Águia**: Disparada e Desengajar como Ação Bônus e desvantagem em ataques de oportunidade contra você.\n• **Lobo**: Seus aliados têm Vantagem em ataques contra inimigos adjacentes a você."
          },
          {
            "level": 6,
            "name": "Aspecto da Fera (Aspect of the Wilds)",
            "desc": "Ganha bônus utilitários como visão no escuro ampliada, capacidade de carga dobrada ou natação e escalada com deslocamento integral."
          },
          {
            "level": 10,
            "name": "Comunhão com a Natureza (Nature Speaker)",
            "desc": "Você pode conjurar as magias *Falar com Animais* e *Sentido Bestial* como rituais."
          },
          {
            "level": 14,
            "name": "Sintonia Totêmica Suprema",
            "desc": "Seus aspectos animais evoluem: o Urso força inimigos a te atacarem, a Águia ganha voo durante a fúria e o Lobo derruba oponentes no chão."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Ao entrar em Fúria e no início de cada um de seus turnos, você ou um aliado visível a até 9 metros ganha PV Temporários iguais ao seu bônus de proficiência + modificador de Constituição."
          },
          {
            "level": 6,
            "name": "Galhos da Árvore do Mundo",
            "desc": "Com uma reação quando um inimigo iniciar o turno a até 9 metros, você manifesta vinhas espectrais que o puxam para perto de você e reduzem seu deslocamento a 0."
          },
          {
            "level": 10,
            "name": "Bater de Raízes",
            "desc": "Ao usar Golpe Brutal, você pode atingir todos os inimigos ao redor do alvo com galhos pesados que causam dano de força."
          },
          {
            "level": 14,
            "name": "Caminho pelas Raízes (Travel Along the Tree)",
            "desc": "Você pode se teleportar junto com aliados através dos galhos dimensionais de Yggdrasil até 18 metros como ação bônus."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "O primeiro alvo que você acertar com uma arma no seu turno durante a Fúria sofre 1d6 + metade do seu nível de bárbaro de dano Radiante ou Necrótico."
          },
          {
            "level": 6,
            "name": "Fã do Fanático (Fanatical Focus)",
            "desc": "Se falhar em uma salvaguarda durante a Fúria, você pode rolar o dado novamente uma vez por uso de fúria."
          },
          {
            "level": 10,
            "name": "Presença Zelosa (Zealous Presence)",
            "desc": "Como ação bônus, você solta um grito sagrado concedendo Vantagem em jogadas de ataque e salvaguardas para até 10 aliados a até 18 metros."
          },
          {
            "level": 14,
            "name": "Fúria Além da Morte (Rage Beyond Death)",
            "desc": "Estar com 0 pontos de vida não te deixa inconsciente enquanto estiver em Fúria. Você só morre por falhas de salvaguarda se a Fúria acabar antes de você recuperar PV."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Estilo de Luta, Retomar o Fôlego (Second Wind), Maestria em Armas (3)",
        "mastery": "3"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Surto de Ação (Action Surge), Mente Tática",
        "mastery": "3"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Guerreiro",
        "mastery": "3"
      },
      {
        "level": 4,
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Ataque Extra (2 ataques), Mudança Tática",
        "mastery": "4"
      },
      {
        "level": 6,
      ...
      },
      {
        "level": 9,
        "prof": "+4",
        "features": "Indomável (1 uso), Maestria Tática",
        "mastery": "4"
      },
      {
        "level": 10,
      ...
      },
      {
        "level": 13,
        "prof": "+5",
        "features": "Indomável (2 usos), Especialista em Maestria",
        "mastery": "5"
      },
      {
        "level": 14,
      ...
      },
      {
        "level": 17,
        "prof": "+6",
        "features": "Surto de Ação (2 usos), Indomável (3 usos)",
        "mastery": "6"
      },
      {
        "level": 18,
        ...
        "features": [
          {
            ...
            "desc": "Seus ataques com armas obtêm acerto crítico em rolagens de 19 ou 20 no d20."
          },
          {
            "level": 3,
            "name": "Atleta Notável (Remarkable Athlete)",
            "desc": "Você tem Vantagem em testes de Iniciativa e em testes de Atletismo. Além disso, ao conseguir um acerto crítico, você pode se mover metade do seu deslocamento sem ataques de oportunidade."
          },
          {
            "level": 7,
            "name": "Estilo de Luta Adicional",
            "desc": "Você escolhe um segundo Estilo de Luta da lista de guerreiro."
          },
          {
            "level": 10,
            "name": "Guerreiro Heroico",
            "desc": "No início de cada um de seus turnos em combate, se não tiver Inspiração Heroica, você a ganha automaticamente."
          },
          {
            "level": 15,
            "name": "Crítico Superior",
            "desc": "Seus ataques com armas conseguem acerto crítico em rolagens de 18, 19 ou 20."
          },
          {
            "level": 18,
            "name": "Sobrevivente (Survivor)",
            "desc": "No início de cada turno, se estiver com menos da metade dos seus PV máximos, você recupera 5 + modificador de Constituição PV."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Você ganha 4 Dados de Superioridade (d8) para executar Manobras como: *Ataque de Desarme*, *Golpe de Empurrão*, *Finta*, *Riposte*, *Manobra de Distração*, *Comando Tático* e *Ataque de Precisão*."
          },
          {
            "level": 7,
            "name": "Conheça seu Inimigo (Know Your Enemy)",
            "desc": "Ao observar um oponente por 1 minuto ou após acertá-lo em combate, você descobre suas imunidades, resistências, vulnerabilidades e valores de CA/Salvaguardas."
          },
          {
            "level": 10,
            "name": "Dados de Superioridade Aprimorados",
            "desc": "Seus dados de superioridade tornam-se d10 (e d12 no nível 18)."
          },
          {
            "level": 15,
            "name": "Implacável (Relentless)",
            "desc": "Uma vez por turno, ao executar uma manobra, você pode rolar 1d8 no lugar de gastar um dado de superioridade da sua reserva."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Conjuração Arcana (Spellcasting)",
            "desc": "Você aprende truques e magias de 1º a 4º círculo da lista de Mago, utilizando Inteligência como atributo de conjuração."
          },
          {
            "level": 3,
            "name": "Vínculo com Arma (Weapon Bond)",
            "desc": "Você cria um elo mágico com até 2 armas. Você não pode ser desarmado delas e pode invocá-las para sua mão instantaneamente como ação bônus de qualquer distância no mesmo plano."
          },
          {
            "level": 7,
            "name": "Magia de Guerra (War Magic)",
            "desc": "Ao realizar a ação de Ataque, você pode substituir um dos seus ataques pelo lançamento de um Truque ou magia de 1º círculo."
          },
          {
            "level": 15,
            "name": "Investida Arcana",
            "desc": "Ao usar Surto de Ação, você pode se teleportar até 9 metros antes ou depois da ação adicional."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Poder Psiônico",
            "desc": "Você possui uma reserva de Dados de Energia Psiônica (d6 a d12) baseados no dobro do seu bônus de proficiência. Pode usá-los para:\n• **Golpe Telecinético**: Causa dano de Força extra ao acertar um ataque.\n• **Campo Protetor**: Reduz o dano sofrido por você ou um aliado adjacente.\n• **Movimento Telecinético**: Move objetos ou criaturas a até 9 metros."
          },
          {
            "level": 7,
            "name": "Salto Psiônico & Golpe Telecinético",
            "desc": "Você pode voar com o dobro do seu deslocamento por 1 turno e derrubar alvos com a mente."
          },
          {
            "level": 10,
            "name": "Mente Blindada",
            "desc": "Resistência a dano psíquico e encerramento de efeitos de Enfeitiçado/Amedrontado no início do turno."
          },
          {
            "level": 15,
            "name": "Bastião de Vigor",
            "desc": "Concede meia cobertura e bônus de CA para você e aliados ao seu redor."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Especialização (2 perícias), Ataque Furtivo (1d6), Gíria de Ladrão, Maestria",
        "sneak": "1d6"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Ação Astuta (Cunning Action)",
        "sneak": "1d6"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Ladino, Mira Firme",
        "sneak": "2d6"
      },
      {
        "level": 4,
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Esquiva Sobrenatural (Uncanny Dodge), Golpe Sagaz",
        "sneak": "3d6"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Especialização (mais 2 perícias)",
        "sneak": "3d6"
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Evasão (Evasion), Ação Astuta Aprimorada",
        "sneak": "4d6"
      },
      {
        "level": 8,
      ...
      },
      {
        "level": 11,
        "prof": "+4",
        "features": "Talento Confiável (Reliable Talent)",
        "sneak": "6d6"
      },
      {
        "level": 12,
      ...
      },
      {
        "level": 14,
        "prof": "+5",
        "features": "Sentido Cego (Blindsense 3m)",
        "sneak": "7d6"
      },
      {
        "level": 15,
        "prof": "+5",
        "features": "Mente Escorregadia (Proficiência em Sabedoria e Carisma)",
        "sneak": "8d6"
      },
      {
        "level": 16,
      ...
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Elusivo (Inimigos não ganham Vantagem contra você)",
        "sneak": "9d6"
      },
      {
        "level": 19,
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Golpe de Sorte (Transforma erro em acerto ou teste em 20)",
        "sneak": "10d6"
      }
    ],
    "features": [
    ...
    "subclasses": [
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Emboscada Mortal (Assassinate)",
            "desc": "Você tem Vantagem em ataques contra criaturas que ainda não agiram no combate e seus acertos causam dano crítico garantido em alvos Surpresos."
          },
          {
            "level": 9,
            "name": "Infiltração e Disfarces",
            "desc": "Você cria identidades falsas impecáveis e imita vozes com perfeição absoluta."
          },
          {
            "level": 13,
            "name": "Golpe do Impostor",
            "desc": "Vantagem em ataques e testes contra alvos enganados por seus disfarces."
          },
          {
            "level": 17,
            "name": "Golpe Mortal (Death Strike)",
            "desc": "Ao atingir uma criatura surpresa, ela deve passar em Salvaguarda de Constituição ou terá todo o dano do seu ataque dobrado!"
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Você pode usar sua Ação Astuta para usar Ferramentas de Ladrão, desarmar armadilhas ou usar a ação Utilizar Objeto."
          },
          {
            "level": 3,
            "name": "Trabalho de Segundo Andar",
            "desc": "Escalar não custa movimento extra e seu salto em distância é aumentado."
          },
          {
            "level": 9,
            "name": "Furtividade Suprema",
            "desc": "Vantagem em testes de Furtividade caso se mova até metade do deslocamento."
          },
          {
            "level": 13,
            "name": "Usar Item Mágico (Use Magic Device)",
            "desc": "Você ignora todos os requisitos de classe, raça e nível para sintonizar e usar qualquer item mágico!"
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Conjuração de Trapaceiro",
            "desc": "Aprende truques e magias das escolas de Ilusão e Encantamento da lista de Mago."
          },
          {
            "level": 3,
            "name": "Mãos Mágicas Trapaceiras",
            "desc": "Seu truque Mãos Mágicas fica invisível e pode arrombar fechaduras e guardar/pegar itens de terceiros à distância."
          },
          {
            "level": 9,
            "name": "Emboscada Mágica",
            "desc": "Se estiver escondido ao lançar uma magia, os alvos têm Desvantagem nas salvaguardas contra ela."
          },
          {
            "level": 13,
            "name": "Trapaceiro Versátil",
            "desc": "Usa a Mão Mágica para distrair alvos e ganhar Ataque Furtivo garantido."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Materializa adagas psíquicas mágicas que causam dano Psíquico (1d6) e permitem um segundo ataque bônus (1d4)."
          },
          {
            "level": 3,
            "name": "Poder Psiônico da Mente",
            "desc": "Ganha dados de energia psiônica para adicionar a testes de perícia falhos (*Perícia Guiada*) e criar comunicação telepática com o grupo."
          },
          {
            "level": 9,
            "name": "Arremesso Telecinético",
            "desc": "Adiciona dados psiônicos para acertar ataques à distância com as lâminas mentais."
          },
          {
            "level": 13,
            "name": "Voo Psíquico e Invisibilidade",
            "desc": "Fica invisível por 1 hora e teleporta-se através de suas lâminas."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Grimório de Magias, Recuperação Arcana, Rituais",
        "cantrips": "3",
        "slots": "2 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Especialização do Erudito (Arcana/História)",
        "cantrips": "3",
        "slots": "3 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Mago (Escola de Magia)",
        "cantrips": "3",
        "slots": "4 (1º), 2 (2º)"
      },
      {
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Magias de 3º Círculo",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Habilidade de Subclasse",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 3 (3º)"
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Magias de 4º Círculo",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 3 (3º), 1 (4º)"
      },
      {
        "level": 8,
        "prof": "+3",
        "features": "Aumento no Valor de Atributo / Talento",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 3 (3º), 2 (4º)"
      },
      {
        "level": 9,
        "prof": "+4",
        "features": "Magias de 5º Círculo",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 1 (5º)"
      },
      {
        "level": 10,
        "prof": "+4",
        "features": "Habilidade de Subclasse",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º)"
      },
      {
        "level": 11,
        "prof": "+4",
        "features": "Magias de 6º Círculo",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º)"
      },
      {
        "level": 12,
        "prof": "+4",
      ...
      },
      {
        "level": 13,
        "prof": "+5",
        "features": "Magias de 7º Círculo",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º)"
      },
      {
        "level": 14,
        "prof": "+5",
      ...
      },
      {
        "level": 15,
        "prof": "+5",
        "features": "Magias de 8º Círculo",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º), 1 (8º)"
      },
      {
        "level": 16,
        "prof": "+5",
      ...
      },
      {
        "level": 17,
        "prof": "+6",
        "features": "Magias de 9º Círculo (Desejo, Chuva de Meteoros)",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º), 1 (8º), 1 (9º)"
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Maestria em Magia (Spell Mastery - Truque de 1º e 2º à vontade)",
        "cantrips": "5",
        "slots": "Slots Padrão"
      },
      {
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Assinatura Mágica (Duas magias de 3º sempre preparadas)",
        "cantrips": "5",
        "slots": "Slots Padrão"
      }
    ],
        ...
        "features": [
          {
            ...
            "desc": "Ao conjurar magias de evocação em área (como Bola de Fogo), você escolhe até 1 + círculo da magia criaturas que passam automaticamente na salvaguarda e não sofrem dano algum!"
          },
          {
            "level": 6,
            "name": "Truque Potente (Potent Cantrip)",
            "desc": "Criaturas que passarem na salvaguarda contra seus truques ainda sofrem metade do dano normal."
          },
          {
            "level": 10,
            "name": "Evocação Empoderada",
            "desc": "Adiciona seu modificador de Inteligência em todas as rolagens de dano de magias de evocação."
          },
          {
            "level": 14,
            "name": "Sobrecarga Mágica (Overchannel)",
            "desc": "Maximiza o dano total de magias de 1º a 5º círculo sem rolar dados (dano total máximo)."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Proteção Arcana (Arcane Ward)",
            "desc": "Ao conjurar uma magia de abjuração, você cria uma barreira protetora com PV iguais a 2x nível de mago + Inteligência que absorve dano antes dos seus PV."
          },
          {
            "level": 6,
            "name": "Proteção Projetada",
            "desc": "Com uma reação, sua Proteção Arcana se desloca para absorver o dano recebido por um aliado a até 9 metros."
          },
          {
            "level": 10,
            "name": "Abjuração Aprimorada",
            "desc": "Adiciona seu bônus de proficiência em testes de Contramagia e Dissipar Magia."
          },
          {
            "level": 14,
            "name": "Resistência a Magias",
            "desc": "Vantagem em salvaguardas contra todas as magias e resistência ao dano delas."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Presságio (Portent)",
            "desc": "Ao terminar um Descanso Longo, você rola 2d20 e anota os resultados. Pode substituir qualquer d20 de ataque, salvaguarda ou teste seu ou de outra criatura por um desses números!"
          },
          {
            "level": 6,
            "name": "Adivinho Especialista",
            "desc": "Conjurar magias de adivinhação devolve espaços de magia de círculos inferiores."
          },
          {
            "level": 10,
            "name": "Terceiro Olho (The Third Eye)",
            "desc": "Ganha Visão no Escuro (36m), Visão Etérea, Ler Qualquer Idioma ou Ver o Invisível à sua escolha."
          },
          {
            "level": 14,
            "name": "Presságio Maior",
            "desc": "Você agora rola 3d20 de Presságio a cada descanso longo."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Aprende Ilusão Menor com som e imagem simultâneos como Ação Bônus."
          },
          {
            "level": 6,
            "name": "Maleabilidade Ilusória",
            "desc": "Altera a natureza e o visual de uma ilusão já criada sem precisar reconjurá-la."
          },
          {
            "level": 10,
            "name": "Dublê Ilusório",
            "desc": "Com uma reação ao ser atacado, uma cópia ilusória absorve o golpe, fazendo o ataque errar automaticamente."
          },
          {
            "level": 14,
            "name": "Realidade Ilusória (Illusory Reality)",
            "desc": "Você pode tornar um objeto inanimado não mágico de uma ilusão em matéria real e física por 1 minuto!"
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Conjuração Divina, Ordem Divina (Protetor ou Taumaturgo)",
        "cantrips": "3",
        "slots": "2 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Canalizar Divindade (2 usos), Expulsar Mortos-Vivos, Centelha Divina",
        "cantrips": "3",
        "slots": "3 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Clérigo (Domínio Divino)",
        "cantrips": "3",
        "slots": "4 (1º), 2 (2º)"
      },
      {
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Destruir Mortos-Vivos (ND 1/2 ou menor)",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Habilidade de Subclasse, Canalizar Divindade (3 usos)",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 3 (3º)"
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Golpe Abençoado ou Conjuração Potente",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 3 (3º), 1 (4º)"
      },
      {
      ...
      },
      {
        "level": 10,
        "prof": "+4",
        "features": "Intervenção Divina (Sucesso garantido)",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º)"
      },
      {
        "level": 11,
        "prof": "+4",
        "features": "Destruir Mortos-Vivos (ND 2)",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º)"
      },
      {
      ...
      },
      {
        "level": 14,
        "prof": "+5",
        "features": "Destruir Mortos-Vivos (ND 3)",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º)"
      },
      {
      ...
      },
      {
        "level": 17,
        "prof": "+6",
        "features": "Habilidade de Subclasse, Destruir Mortos-Vivos (ND 4)",
        "cantrips": "5",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º), 1 (8º), 1 (9º)"
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Canalizar Divindade (4 usos)",
        "cantrips": "5",
        "slots": "Slots Padrão"
      },
      {
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Intervenção Divina Maior (Conjura magia de até 9º círculo)",
        "cantrips": "5",
        "slots": "Slots Padrão"
      }
    ],
        ...
        "features": [
          {
            ...
            "desc": "Sempre que usar uma magia de 1º círculo ou superior para restaurar PV, a criatura recupera 2 + círculo da magia PV adicionais."
          },
          {
            "level": 3,
            "name": "Preservar a Vida (Canalizar Divindade)",
            "desc": "Cura um total de 5x seu nível de clérigo distribuído entre aliados a até 9m com menos da metade da vida."
          },
          {
            "level": 6,
            "name": "Curandeiro Abençoado",
            "desc": "Ao curar um aliado com magia, você também recupera PV iguais a 2 + círculo da magia."
          },
          {
            "level": 17,
            "name": "Cura Suprema",
            "desc": "Todas as suas magias de cura curam o valor máximo possível nos dados sem rolar."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Clarão Protetor (Warding Flare)",
            "desc": "Com uma reação ao ser atacado por criatura a até 9m, você emite uma luz ofuscante impondo Desvantagem no ataque."
          },
          {
            "level": 3,
            "name": "Raios da Aurora (Canalizar Divindade)",
            "desc": "Dissipa qualquer escuridão mágica e causa 2d10 + nível de clérigo de dano Radiante a todos os inimigos a até 9m."
          },
          {
            "level": 6,
            "name": "Clarão Aprimorado",
            "desc": "Você pode usar o Clarão Protetor quando um aliado for atacado."
          },
          {
            "level": 17,
            "name": "Corona de Luz",
            "desc": "Emite uma aura de 18m de luz solar impondo desvantagem nas salvaguardas contra suas magias de fogo e radiantes."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Concede Vantagem em testes de Furtividade para uma criatura tocada."
          },
          {
            "level": 3,
            "name": "Invocar Duplicata (Canalizar Divindade)",
            "desc": "Cria uma cópia ilusória perfeita que se move até 9m e através da qual você pode conjurar magias com Vantagem."
          },
          {
            "level": 6,
            "name": "Capa de Sombras",
            "desc": "Fica invisível como reação ao ser atacado ou como ação bônus."
          },
          {
            "level": 17,
            "name": "Duplicata Suprema",
            "desc": "Você cria até 4 duplicatas ilusórias simultâneas no campo de batalha."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Ao usar a ação de Ataque, você pode desferir um ataque extra com arma como Ação Bônus."
          },
          {
            "level": 3,
            "name": "Golpe Guiado (Canalizar Divindade)",
            "desc": "Concede +10 de bônus na jogada de ataque para garantir o acerto."
          },
          {
            "level": 6,
            "name": "Bênção do Deus da Guerra",
            "desc": "Você pode conceder o bônus de +10 no ataque para um aliado a até 9m."
          },
          {
            "level": 17,
            "name": "Avatar da Batalha",
            "desc": "Resistência permanente a dano de concussão, cortante e perfurante não mágico."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Imposição das Mãos (Lay on Hands), Conjuração, Sentido Divino",
        "slots": "2 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Estilo de Luta, Golpe Divino (Divine Smite)",
        "slots": "2 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Paladino (Juramento Sagrado), Canalizar Divindade",
        "slots": "3 (1º)"
      },
      {
        "level": 4,
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Ataque Extra, Encontrar Montaria (Gratuita 1x/dia)",
        "slots": "4 (1º), 2 (2º)"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Aura de Proteção (Adiciona Carisma a todas as salvaguardas)",
        "slots": "4 (1º), 2 (2º)"
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Habilidade de Juramento (Aura de Subclasse)",
        "slots": "4 (1º), 3 (2º)"
      },
      {
        "level": 8,
      ...
      },
      {
        "level": 10,
        "prof": "+4",
        "features": "Aura de Coragem (Imunidade a Amedrontado)",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
        "level": 11,
        "prof": "+4",
        "features": "Golpe Divino Radiante (+1d8 permanente em todo ataque)",
        "slots": "4 (1º), 3 (2º), 3 (3º)"
      },
      {
        "level": 12,
      ...
      },
      {
        "level": 14,
        "prof": "+5",
        "features": "Toque Purificador (Remove condições como ação bônus)",
        "slots": "4 (1º), 3 (2º), 3 (3º), 1 (4º)"
      },
      {
        "level": 15,
        "prof": "+5",
        "features": "Habilidade de Juramento",
        "slots": "4 (1º), 3 (2º), 3 (3º), 2 (4º)"
      },
      {
        "level": 16,
      ...
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Auras Expandidas (Raio aumenta para 9 metros)",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 1 (5º)"
      },
      {
        "level": 19,
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Campeão do Juramento (Transformação Avatar Suprema)",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º)"
      }
    ],
    "features": [
    ...
    "subclasses": [
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Arma Sagrada (Canalizar Divindade)",
            "desc": "Adiciona seu modificador de Carisma em todas as jogadas de ataque com a arma e emite luz mágica por 1 minuto."
          },
          {
            "level": 7,
            "name": "Aura de Devoção",
            "desc": "Você e aliados na aura são imunes à condição Enfeitiçado."
          },
          {
            "level": 15,
            "name": "Golpe Purificador",
            "desc": "Seus ataques dissipam magias de encantamento e possessão nos alvos."
          },
          {
            "level": 20,
            "name": "Halo Sagrado",
            "desc": "Transforma-se em um anjo de luz causando dano radiante contínuo e ganhando Vantagem em salvaguardas."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Voto de Inimizade (Vow of Enmity)",
            "desc": "Como ação bônus, você ganha Vantagem garantida em todas as jogadas de ataque contra um alvo a até 9m por 1 minuto!"
          },
          {
            "level": 7,
            "name": "Vingador Implacável",
            "desc": "Ao acertar um ataque de oportunidade, você pode se mover até metade do seu deslocamento como parte da reação."
          },
          {
            "level": 15,
            "name": "Alma Vingativa",
            "desc": "Sempre que a criatura sob o Voto de Inimizade atacar, você pode desferir um ataque corpo a corpo contra ela como reação."
          },
          {
            "level": 20,
            "name": "Anjo Vingador",
            "desc": "Ganha asas com deslocamento de voo de 18m e emite uma aura de pavor aterrorizante."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Ira da Natureza (Canalizar Divindade)",
            "desc": "Gera vinhas espectrais que prendem e impedem um oponente a até 9m."
          },
          {
            "level": 7,
            "name": "Aura de Proteção Arcana",
            "desc": "Você e aliados na aura têm Resistência ao dano de todas as magias!"
          },
          {
            "level": 15,
            "name": "Sentinela Imortal",
            "desc": "Ao cair a 0 PV, você retorna a 1 PV uma vez por descanso longo e não pode sofrer envelhecimento mágico."
          },
          {
            "level": 20,
            "name": "Campeão Ancião",
            "desc": "Regenera 10 PV por turno e conjura magias de paladino com Ação Bônus."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Vantagem em testes de Força e Atletismo e saltos aumentados por 10 minutos."
          },
          {
            "level": 7,
            "name": "Aura de Rapidez",
            "desc": "Seu deslocamento e o de seus aliados na aura aumenta em +3 metros (+10 ft)."
          },
          {
            "level": 15,
            "name": "Defesa Gloriosa",
            "desc": "Com uma reação, concede bônus de CA para um aliado e desfere um contra-ataque imediato."
          },
          {
            "level": 20,
            "name": "Lenda Viva",
            "desc": "Vantagem em testes de Carisma, transforma erro em acerto e ganha re-rolagem de salvaguardas."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Inspiração Bárdica (d6), Conjuração",
        "die": "d6",
        "slots": "2 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Especialização (2 perícias), Pau pra Toda Obra (Jack of All Trades)",
        "die": "d6",
        "slots": "3 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Bardo (Colégio Bárdico)",
        "die": "d6",
        "slots": "4 (1º), 2 (2º)"
      },
      {
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Inspiração Bárdica (d8), Fonte de Inspiração (Recupera em Descanso Curto)",
        "die": "d8",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Habilidade de Subclasse, Contra-encanto",
        "die": "d8",
        "slots": "4 (1º), 3 (2º), 3 (3º)"
      },
      {
      ...
      },
      {
        "level": 10,
        "prof": "+4",
        "features": "Segredos Mágicos (Aprende magias de Clerigo, Druida ou Mago!)",
        "die": "d10",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º)"
      },
      {
      ...
      },
      {
        "level": 15,
        "prof": "+5",
        "features": "Inspiração Bárdica (d12)",
        "die": "d12",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º), 1 (8º)"
      },
      {
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Palavras da Criação (Recupera inspiração e maximiza cura/dano)",
        "die": "d12",
        "slots": "Slots Padrão"
      }
    ],
        ...
        "features": [
          {
            ...
            "desc": "Com uma reação, usa a Inspiração Bárdica para subtrair do ataque, dano ou teste de um oponente."
          },
          {
            "level": 6,
            "name": "Segredos Mágicos Adicionais",
            "desc": "Aprende 2 magias adicionais de qualquer classe já no nível 6."
          },
          {
            "level": 14,
            "name": "Habilidade Incomparável",
            "desc": "Soma o dado de inspiração em seus próprios testes de perícia."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Proficiências Marciais",
            "desc": "Ganha proficiência com Armaduras Médias, Escudos e Armas Marciais."
          },
          {
            "level": 3,
            "name": "Inspiração de Combate",
            "desc": "Aliados podem somar o dado de inspiração diretamente no dano de suas armas ou na CA como reação."
          },
          {
            "level": 6,
            "name": "Ataque Extra (com Truque)",
            "desc": "Pode atacar duas vezes ou substituir um ataque por um Truque."
          },
          {
            "level": 14,
            "name": "Magia de Batalha",
            "desc": "Ao conjurar uma magia com sua ação, pode desferir um ataque com arma como ação bônus."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Concede PV Temporários e movimento imediato sem ataques de oportunidade para até 5 aliados."
          },
          {
            "level": 6,
            "name": "Manto de Majestade",
            "desc": "Conjura Comando como Ação Bônus sem gastar espaços de magia a cada turno."
          },
          {
            "level": 14,
            "name": "Majestade Inabalável",
            "desc": "Inimigos precisam passar em Salvaguarda de Carisma antes de conseguirem atacar você."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Acrobata Desarmado",
            "desc": "Usa Carisma para CA sem armadura e ataca desarmado usando o dado de Inspiração Bárdica."
          },
          {
            "level": 6,
            "name": "Passos Inspiradores",
            "desc": "Ao gastar inspiração, você e aliados adjacentes podem se mover sem provocar ataques de oportunidade."
          },
          {
            "level": 14,
            "name": "Dança da Evasão Total",
            "desc": "Concede Evasão compartilhada para aliados próximos contra magias em área."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Conjuração Primitiva, Ordem Primitiva (Mago ou Protetor)",
        "cantrips": "2",
        "slots": "2 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Forma Selvagem (Wild Shape - 2 usos), Companheiro Selvagem",
        "cantrips": "2",
        "slots": "3 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Druida (Círculo Druídico)",
        "cantrips": "2",
        "slots": "4 (1º), 2 (2º)"
      },
      {
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Forma Selvagem (Natação / Ataque Mágico)",
        "cantrips": "3",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
      ...
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Golpes Elementais ou Conjurador Potente",
        "cantrips": "3",
        "slots": "4 (1º), 3 (2º), 3 (3º), 1 (4º)"
      },
      {
      ...
      },
      {
        "level": 17,
        "prof": "+6",
        "features": "Magias de 9º Círculo (Tempestade da Vingança, Forma de Dragão)",
        "cantrips": "4",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º), 1 (8º), 1 (9º)"
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Corpo Atemporal, Magia de Fera",
        "cantrips": "4",
        "slots": "Slots Padrão"
      },
      {
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Arquidruida (Forma Selvagem ilimitada e conversão em cura)",
        "cantrips": "4",
        "slots": "Slots Padrão"
      }
    ],
        ...
        "features": [
          {
            ...
            "desc": "Transforma-se em bestas de ND superior com CA aumentada (13 + Sabedoria) e PV Temporários extras de 3x nível de druida."
          },
          {
            "level": 6,
            "name": "Golpes Lunares Primordiais",
            "desc": "Seus ataques de besta causam dano Radiante e superam resistências a armas não mágicas."
          },
          {
            "level": 10,
            "name": "Teleporte Luz da Lua",
            "desc": "Teleporta-se até 9 metros como ação bônus após acertar um ataque na Forma Selvagem."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Magias da Terra & Recuperação Natural",
            "desc": "Aprende magias adicionais do seu bioma e recupera espaços de magia em descanso curto."
          },
          {
            "level": 6,
            "name": "Passo da Terra",
            "desc": "Imunidade a terreno difícil e resistência a veneno/doença."
          },
          {
            "level": 10,
            "name": "Santuário da Natureza",
            "desc": "Criaturas do tipo besta e planta hesitam antes de atacá-lo."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Forma Estelar",
            "desc": "Assume constelações brilhantes que disparam flechas de luz (*Arqueiro*), amplificam curas (*Cálice*) ou garantem concentração (*Dragão*)."
          },
          {
            "level": 6,
            "name": "Presságio Cósmico (Weal & Woe)",
            "desc": "Rola dados no início do dia para adicionar bônus a aliados ou subtrair de inimigos."
          },
          {
            "level": 10,
            "name": "Estrelas Cintilantes",
            "desc": "Ganha deslocamento de voo e resistência a danos físicos na Forma Estelar."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Fúria das Ondas",
            "desc": "Cria uma tempestade ao redor de si causando dano elétrico e empurrando inimigos."
          },
          {
            "level": 6,
            "name": "Afinidade Aquática",
            "desc": "Deslocamento de natação e respiração sob a água contínua."
          },
          {
            "level": 10,
            "name": "Correnteza Protetora",
            "desc": "Resistência a dano de frio, elétrico e trovejante."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Feitiçaria Inata (Innate Sorcery), Conjuração",
        "sp": "0",
        "slots": "2 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Fonte de Magia (Pontos de Feitiçaria), Metamagia (2 opções)",
        "sp": "2",
        "slots": "3 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Feiticeiro (Origem Mágica)",
        "sp": "3",
        "slots": "4 (1º), 2 (2º)"
      },
      {
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Feitiçaria Inata Aprimorada",
        "sp": "5",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
      ...
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Magias de 4º Círculo, Metamagia Adicional",
        "sp": "7",
        "slots": "4 (1º), 3 (2º), 3 (3º), 1 (4º)"
      },
      {
      ...
      },
      {
        "level": 13,
        "prof": "+5",
        "features": "Magias de 7º Círculo, Metamagia Adicional",
        "sp": "13",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º), 1 (6º), 1 (7º)"
      },
      {
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Apoteose Feiticeira (Recupera 4 pontos de feitiçaria em descanso curto)",
        "sp": "20",
        "slots": "Slots Padrão"
      }
    ],
        ...
        "features": [
          {
            ...
            "desc": "Sua CA sem armadura é 13 + Des e você ganha +1 PV máximo por nível de feiticeiro."
          },
          {
            "level": 6,
            "name": "Afinidade Elemental",
            "desc": "Adiciona Carisma no dano do elemento do seu dragão e ganha resistência a esse elemento."
          },
          {
            "level": 14,
            "name": "Asas de Dragão",
            "desc": "Manifesta asas dracônicas com deslocamento de voo de 18m."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Surto de Magia Selvagem & Marés de Caos",
            "desc": "Ganha Vantagem imediata em qualquer rolagem e rola na Tabela de Surto Selvagem."
          },
          {
            "level": 6,
            "name": "Dobrar a Sorte",
            "desc": "Gasta pontos de feitiçaria para adicionar ou subtrair 1d4 de rolagens de outras criaturas."
          },
          {
            "level": 14,
            "name": "Caos Controlado",
            "desc": "Rola duas vezes na tabela de surto e escolhe qual resultado prefere aplicar."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Magias Psiônicas & Telepatia",
            "desc": "Comunicação mental com criaturas e conjuração sutil psíquica sem componentes."
          },
          {
            "level": 6,
            "name": "Defesas Psíquicas",
            "desc": "Resistência a dano Psíquico e Vantagem contra ser Enfeitiçado/Amedrontado."
          },
          {
            "level": 14,
            "name": "Carne Revelada",
            "desc": "Transforma o corpo em tentáculos que voam, nadam e atravessam frestas minúsculas."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Com uma reação, anula qualquer Vantagem ou Desvantagem em uma rolagem a até 18m."
          },
          {
            "level": 6,
            "name": "Bastião da Lei",
            "desc": "Cria um escudo de força que reduz dano sofrido por você ou aliados."
          },
          {
            "level": 14,
            "name": "Transe da Ordem",
            "desc": "Qualquer rolagem sua no d20 de 9 ou menor se torna automaticamente um 10."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Magia de Pacto, Patrono Sobrenatural, Truque Rajada Mística",
        "cantrips": "2",
        "pactSlots": "1 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Invocações Místicas (2 invocações)",
        "cantrips": "2",
        "pactSlots": "2 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Bruxo, Dádiva do Pacto (Lâmina, Tomo ou Corrente)",
        "cantrips": "2",
        "pactSlots": "2 (2º)"
      },
      {
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Invocações Místicas (3 invocações)",
        "cantrips": "3",
        "pactSlots": "2 (3º)"
      },
      {
      ...
      },
      {
        "level": 7,
        "prof": "+3",
        "features": "Invocações Místicas (4 invocações)",
        "cantrips": "3",
        "pactSlots": "2 (4º)"
      },
      {
      ...
      },
      {
        "level": 9,
        "prof": "+4",
        "features": "Invocações Místicas (5 invocações)",
        "cantrips": "3",
        "pactSlots": "2 (5º)"
      },
      {
      ...
      },
      {
        "level": 11,
        "prof": "+4",
        "features": "Arcano Secreto (Magia de 6º Círculo 1x/dia)",
        "cantrips": "4",
        "pactSlots": "3 (5º)"
      },
      {
        "level": 12,
        "prof": "+4",
        "features": "Aumento no Valor de Atributo / Talento, Invocações (6)",
        "cantrips": "4",
        "pactSlots": "3 (5º)"
      },
      {
        "level": 13,
        "prof": "+5",
        "features": "Arcano Secreto (Magia de 7º Círculo 1x/dia)",
        "cantrips": "4",
        "pactSlots": "3 (5º)"
      },
      {
      ...
      },
      {
        "level": 15,
        "prof": "+5",
        "features": "Arcano Secreto (Magia de 8º Círculo 1x/dia), Invocações (7)",
        "cantrips": "4",
        "pactSlots": "3 (5º)"
      },
      {
      ...
      },
      {
        "level": 17,
        "prof": "+6",
        "features": "Arcano Secreto (Magia de 9º Círculo 1x/dia), 4 Slots de Pacto",
        "cantrips": "4",
        "pactSlots": "4 (5º)"
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Invocações Místicas (8 invocações)",
        "cantrips": "4",
        "pactSlots": "4 (5º)"
      },
      {
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Mestre do Pacto (Recupera todos os espaços de pacto em 1 minuto)",
        "cantrips": "4",
        "pactSlots": "4 (5º)"
      }
    ],
        ...
        "features": [
          {
            ...
            "desc": "Ao reduzir um inimigo a 0 PV, você ganha PV Temporários iguais ao seu Carisma + nível de bruxo."
          },
          {
            "level": 6,
            "name": "Sorte do Próprio Diabo",
            "desc": "Adiciona 1d10 em uma salvaguarda ou teste de atributo que falharia."
          },
          {
            "level": 10,
            "name": "Resiliência Diabólica",
            "desc": "Escolhe um tipo de dano a cada descanso para ter Resistência garantida."
          },
          {
            "level": 14,
            "name": "Arremessar no Inferno (Hurl Through Hell)",
            "desc": "Ao acertar um ataque, bane o alvo por 1 rodada pelos Nove Infernos, causando 10d10 de dano psíquico!"
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Presença Feérica & Passo Nebuloso",
            "desc": "Pode conjurar Passo Nebuloso sem gastar espaços de magia várias vezes ao dia e encanta/amedronta alvos ao surgir."
          },
          {
            "level": 6,
            "name": "Fuga Nebulosa",
            "desc": "Com uma reação ao sofrer dano, fica invisível e se teleporta 18 metros."
          },
          {
            "level": 10,
            "name": "Mente Sedutora",
            "desc": "Imunidade a ser Enfeitiçado e reflete o encanto de volta no conjurador inimigo."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Mente Desperta",
            "desc": "Comunicação telepática universal com qualquer criatura a até 9 metros."
          },
          {
            "level": 6,
            "name": "Escudo Psíquico",
            "desc": "Imunidade a leitura de pensamentos e reflete metade do dano psíquico no atacante."
          },
          {
            "level": 14,
            "name": "Criar Servo Mental",
            "desc": "Toca uma criatura incapacitada e a transforma em um servo telepático leal a você."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Luz Curativa",
            "desc": "Reserva de dados d6 iguais a 1 + nível de bruxo para curar aliados como ação bônus a até 18m."
          },
          {
            "level": 6,
            "name": "Alma Radiante",
            "desc": "Resistência a dano Radiante e adiciona Carisma em magias de fogo e radiantes."
          },
          {
            "level": 14,
            "name": "Ressurreição Radiante",
            "desc": "Ao cair a 0 PV, explode em luz radiante causando dano nos inimigos e retornando com metade da vida."
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Artes Marciais (1d6), Defesa sem Armadura",
        "die": "1d6",
        "focus": "0"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Pontos de Foco (Ki), Rajada de Golpes, Defesa Paciente, Passo do Vento",
        "die": "1d6",
        "focus": "2"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Monge, Defletir Ataques",
        "die": "1d6",
        "focus": "3"
      },
      {
        "level": 4,
        "prof": "+2",
        "features": "Aumento no Valor de Atributo / Talento, Queda Lenta",
        "die": "1d6",
        "focus": "4"
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Ataque Extra, Golpe Atordoante (Stunning Strike)",
        "die": "1d8",
        "focus": "5"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Habilidade de Subclasse, Golpes Fortalecidos por Foco (Dano de Força)",
        "die": "1d8",
        "focus": "6"
      },
      {
      ...
      },
      {
        "level": 9,
        "prof": "+4",
        "features": "Movimento sem Armadura Aprimorado (Anda em paredes e água)",
        "die": "1d8",
        "focus": "9"
      },
      {
        "level": 10,
        "prof": "+4",
        "features": "Habilidade de Subclasse, Auto-Restauração",
        "die": "1d8",
        "focus": "10"
      },
      {
      ...
      },
      {
        "level": 13,
        "prof": "+5",
        "features": "Defletir Energia (Deflete qualquer tipo de ataque à distância)",
        "die": "1d10",
        "focus": "13"
      },
      {
        "level": 14,
        "prof": "+5",
        "features": "Alma de Diamante (Proficiência em TODAS as salvaguardas!)",
        "die": "1d10",
        "focus": "14"
      },
      {
      ...
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Corpo Vazio (Invisibilidade e resistência a quase todos os danos)",
        "die": "1d12",
        "focus": "18"
      },
      {
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Poder do Foco Perfeito (Recupera foco e +4 Sabedoria/Destreza)",
        "die": "1d12",
        "focus": "20"
      }
    ],
        ...
        "features": [
          {
            ...
            "desc": "Ao acertar a Rajada de Golpes, impõe um efeito no alvo: derruba no chão, empurra 4,5m ou impede reações."
          },
          {
            "level": 6,
            "name": "Completude Corporal",
            "desc": "Cura a si mesmo em 3x nível de monge como ação bônus 1x ao dia."
          },
          {
            "level": 11,
            "name": "Tranquilidade",
            "desc": "Ganha o efeito da magia Santuário permanentemente após descansos."
          },
          {
            "level": 17,
            "name": "Palma Trêmula (Quivering Palm)",
            "desc": "Implanta vibrações letais no corpo do alvo; ao ativá-las, o alvo deve passar em salvaguarda de Constituição ou cai a 0 PV imediatamente!"
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Conjura Escuridão, Visão no Escuro, Passos sem Pegadas e Silêncio gastando pontos de foco."
          },
          {
            "level": 6,
            "name": "Passo das Sombras",
            "desc": "Teleporta-se até 18 metros de uma sombra para outra como ação bônus e ganha Vantagem no próximo ataque."
          },
          {
            "level": 17,
            "name": "Oportunista",
            "desc": "Desfere um ataque de reação imediato sempre que uma criatura a até 1,5m for atacada por outro aliado."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Seus ataques desarmados ganham alcance de 4,5m e causam dano elemental (fogo, frio, elétrico ou ácido)."
          },
          {
            "level": 6,
            "name": "Explosão Elemental",
            "desc": "Dispara esferas de fogo ou cones de gelo em área gastando pontos de foco."
          },
          {
            "level": 17,
            "name": "Forma Elemental Suprema",
            "desc": "Ganha deslocamento de voo e natação e resistência a danos elementais."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Mãos da Cura & Mãos do Dano",
            "desc": "Cura aliados com toque de foco ou causa dano necrótico extra que envenena sem teste no nível 6."
          },
          {
            "level": 11,
            "name": "Toque Restaurador",
            "desc": "Cura condições de Cegueira, Surdez, Paralisia, Envenenamento e Atordoamento."
          },
          {
            "level": 17,
            "name": "Mão da Ressurreição Suprema",
            "desc": "Toca uma criatura morta nas últimas 24 horas e a ressuscita sem gastar componentes materiais!"
          }
        ]
      }
    ]
    ...
    "progression": [
      {
        "level": 1,
        "prof": "+2",
        "features": "Marca do Caçador (Hunter's Mark gratuita), Conjuração, Maestria",
        "slots": "2 (1º)"
      },
      {
        "level": 2,
        "prof": "+2",
        "features": "Estilo de Luta, Inimigo Favorito Aprimorado",
        "slots": "2 (1º)"
      },
      {
        "level": 3,
        "prof": "+2",
        "features": "Subclasse de Patrulheiro (Arquétipo), Conhecimento Primevo",
        "slots": "3 (1º)"
      },
      {
        "level": 4,
      ...
      },
      {
        "level": 5,
        "prof": "+3",
        "features": "Ataque Extra",
        "slots": "4 (1º), 2 (2º)"
      },
      {
        "level": 6,
        "prof": "+3",
        "features": "Andarilho (Deslocamento +3m, natação e escalada)",
        "slots": "4 (1º), 2 (2º)"
      },
      {
        "level": 7,
      ...
      },
      {
        "level": 9,
        "prof": "+4",
        "features": "Especialista em Perícias (Expertise)",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
        "level": 10,
        "prof": "+4",
        "features": "Desaparecer (Fica invisível como ação bônus)",
        "slots": "4 (1º), 3 (2º), 2 (3º)"
      },
      {
        "level": 11,
      ...
      },
      {
        "level": 14,
        "prof": "+5",
        "features": "Sentidos Ferais (Não sofre desvantagem contra invisíveis)",
        "slots": "4 (1º), 3 (2º), 3 (3º), 1 (4º)"
      },
      {
        "level": 15,
      ...
      },
      {
        "level": 18,
        "prof": "+6",
        "features": "Marca Precisa (Vantagem em ataques contra a presa marcada)",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 1 (5º)"
      },
      {
        "level": 19,
      ...
      },
      {
        "level": 20,
        "prof": "+6",
        "features": "Matador de Inimigos (Soma Sabedoria no dano de todos os ataques)",
        "slots": "4 (1º), 3 (2º), 3 (3º), 3 (4º), 2 (5º)"
      }
    ],
    "features": [
        ...
        "features": [
          {
            ...
            "desc": "Invoca uma besta mágica leal que ataca no seu turno com sua ação bônus ou substituindo um dos seus ataques."
          },
          {
            "level": 7,
            "name": "Treinamento Excepcional",
            "desc": "A besta pode Disparar, Desengajar ou Esquivar como ação bônus e seus ataques contam como mágicos."
          },
          {
            "level": 11,
            "name": "Ataque da Fera Duplo",
            "desc": "Sua besta pode atacar duas vezes por turno."
          }
        ]
      },
      {
        ...
        "features": [
          {
            ...
            "desc": "Escolha uma especialidade: *Matador de Gigantes* (contra-ataque imediato), *Destruidor de Colossos* (+1d8 dano) ou *Ceifador de Hordas* (ataque extra gratuito em alvo adjacente)."
          },
          {
            "level": 7,
            "name": "Táticas Defensivas",
            "desc": "Ganha Esquiva Sobrenatural ou Evasão."
          },
          {
            "level": 11,
            "name": "Ataque Múltiplo (Volley / Whirlwind)",
            "desc": "Ataca todos os inimigos em uma área de 3 metros de raio com um único golpe."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Emboscador do Terror",
            "desc": "Soma Sabedoria na Iniciativa, ganha +3m de movimento no 1º turno e desfere um ataque extra com +1d8 de dano."
          },
          {
            "level": 3,
            "name": "Visão Umbral",
            "desc": "Visão no escuro 18m e invisibilidade total contra criaturas que dependem de visão no escuro."
          },
          {
            "level": 11,
            "name": "Rajada do Perseguidor",
            "desc": "Se errar um ataque com arma, pode realizar outro ataque imediatamente."
          }
        ]
      },
      {
        ...
        "features": [
          {
            "level": 3,
            "name": "Golpes Temerosos",
            "desc": "Causa +1d4 de dano Psíquico extra em cada criatura diferente que acertar no turno."
          },
          {
            "level": 3,
            "name": "Graça de Faéria",
            "desc": "Soma seu modificador de Sabedoria em todos os testes de Carisma."
          },
          {
            "level": 7,
            "name": "Torção Feérica",
            "desc": "Ao passar em salvaguarda contra encanto ou amedrontamento, reflete o efeito em outra criatura!"
          }
        ]
      }
    ]
